...
private fun checkPlaybackStateContinuously() {
    ...
    if (params != null && panel != null) {
        ...
        params.x = (resources.displayMetrics.widthPixels - dp(112)).coerceIn(0, if (maxX > 0) maxX else resources.displayMetrics.widthPixels)
        params.y = dp(54).coerceIn(0, if (maxY > 0) maxY else resources.displayMetrics.heightPixels)
